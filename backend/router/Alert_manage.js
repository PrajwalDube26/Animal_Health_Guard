...
const {create_alert,get_alert_by_adminid,get_alert_by_alertid,get_all_alerts,delete_alert_by_alertid,update_alert_by_alertid} = require('../controller/alert');
...
router.get("/get_all_alerts",get_all_alerts);
